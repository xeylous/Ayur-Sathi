 ...
 */
export async function sendLabApprovalEmail({ name, email, password, labId, loginUrl, supportUrl, logo }) {
      ...
      <mj-section background-color="#ffffff" padding="20px" border-radius="8px">
        <mj-column>
          ...
          <mj-text>
            ...
            Congratulations! Your lab (<strong>${labId}</strong>) has been successfully approved on <strong>Ayurसाथी</strong>.
          </mj-text>

          <mj-text>
            You can now log in to your lab dashboard using the credentials below:
          </mj-text>
  ...
  await transporter.sendMail({
    ...
    to: email,
    subject: "Your Ayurसाथी Lab Account is Ready!",
    html,
  });

  console.log(`✅ Lab approval email sent to ${email}`);
}
