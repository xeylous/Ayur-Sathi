...
export default function LandingSkeleton() {
  return (
    <div className="min-h-screen flex flex-col bg-[#ECF39E]/30">
      {/* Navbar Skeleton */}
      <header className="sticky top-0 z-40 border-b bg-white/80 backdrop-blur">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 md:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <SkeletonBox className="h-8 w-20 rounded-lg hidden sm:block" />
            <SkeletonBox className="h-6 w-6 rounded-md md:hidden" />
          </div>
        </div>
      </header>

      {/* Page Content Skeleton */}
      <main className="flex flex-col items-center justify-start py-12 px-6 space-y-12">
