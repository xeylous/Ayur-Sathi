          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-col  gap-2">
                ...
                <button
                  type="submit"
                  className="w-full lg:w-auto px-4 py-2 rounded-md bg-[#90A955] text-white font-bold hover:bg-[#4F772D] focus:outline-none focus:ring-2 focus:ring-[#90A955] flex items-center justify-center transition-all cursor-pointer shadow-sm"
                >
                  Subscribe
                </button>
              </div>
