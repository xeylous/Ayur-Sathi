...
// Home_1.jsx — "How it works" section for Ayur Saathi app
// Uses the green theme (#31572C palette)
  ...
  const items = [
    {
      ...
      desc: "GPS, species, moisture",
    },
    {
      icon: <Factory size={22} />,
      title: "ProcessingStep",
      desc: "Drying, grinding",
    },
    {
      icon: <FlaskConical size={22} />,
      title: "QualityTest",
      desc: "Lab certificates",
    },
    {
      icon: <QrCode size={22} />,
      title: "Smart Label",
      desc: "On-chain QR codes",
    },
    {
      icon: <ShieldCheck size={22} />,
      title: "Compliance",
      desc: "Rules auto-validated",
    },
    {
      icon: <Network size={22} />,
      title: "Permissioned network",
      desc: "Node roles for farmers, labs, processors, manufacturers.",
    },
    {
      icon: <QrCode size={22} />,
      title: "Smart labeling",
      desc: "Unique QR per batch; consumer web portal for provenance.",
    },
    {
      icon: <Boxes size={22} />,
      title: "Interoperable bundles",
      desc: "FHIR-style resources: CollectionEvent, QualityTest, ProcessingStep, Provenance.",
    },
    {
      icon: <BarChart size={22} />,
      title: "Dashboards & reports",
      desc: "Harvest volumes, QA results, sustainability metrics.",
    },
    {
      icon: <Smartphone size={22} />,
      title: "Offline-first capture",
      desc: "Low-bandwidth DApp; SMS-over-blockchain gateway.",
    },
    {
      icon: <Factory size={22} />,
      title: "ERP connectors",
      desc: "REST APIs + plugins for QMS/ERP systems.",
    },
  ];
